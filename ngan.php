                        ...
                        <ul class="list-manager">
                            <li class="manager-item time-table">
                                ...
                                <div class="list-active">
                                    <div class="tb ">
                               <iframe src="hd/hd-list.php" width="800" height="400" frameborder="0"></iframe>

                            </li>
                            <li class="manager-item">
                                <a href="quanlygiaovien/hd-list.php">Quản lý giáo viên</a>
                                <div class="list-active">
                                <div class="tb ">
                                <iframe src="quanlygiaovien/hd-list.php" width="800" height="400" frameborder="0"></iframe>
